""" 1. Considerando o dicionário com o nome dos alunos e suas respectivas notas abaixo, crie uma estrutura de repetição 
...
with open(f'{path}alunos.txt', 'w') as arquivo:
  for aluno, nota in alunos.items():
    arquivo.write(f'{aluno},{nota}\n')

with open(f'{path}alunos.txt', 'r') as tex:
  for linha in tex:
    print(linha)